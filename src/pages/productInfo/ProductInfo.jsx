...
function ProductInfo() {
    ...
    const { loading, setLoading ,addtocartfirebase,cartlen,setcartlen} = context;
    ...
    const decreaseQuantity = () => {
      ...
      const increaseQuantity = () => {
        if(quantity+1>products.quantity){
                    ...
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <h1 className="leading-relaxed border-b-2 mb-5 pb-5">
                                ...
                                &nbsp;&nbsp;
                                {products.quantity > 0 ? products.quantity : "Currently Out Of Stock"}
                                </span>
                            </h1>
                            <h1 className="leading-relaxed border-b-2 mb-5 pb-5">
                                Quantity:  
